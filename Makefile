...
DATA        = sql/extension/maludb_core--0.1.0.sql \
              ...
              sql/extension/maludb_core--0.73.0--0.74.0.sql \
              sql/extension/maludb_core--0.74.0--0.75.0.sql \
              sql/extension/maludb_core--0.75.0--0.76.0.sql \
              sql/extension/maludb_core--0.76.0--0.76.1.sql \
              sql/extension/maludb_core--0.76.1--0.77.0.sql \
              sql/extension/maludb_core--0.77.0--0.78.0.sql \
              sql/extension/maludb_core--0.78.0--0.79.0.sql \
              sql/extension/maludb_core--0.79.0--0.80.0.sql \
              sql/extension/maludb_core--0.80.0--0.80.1.sql \
              ...
              sql/extension/maludb_core--0.82.0--0.83.0.sql \
              sql/extension/maludb_core--0.83.0--0.84.0.sql \
              sql/extension/maludb_core--0.84.0--0.85.0.sql \
              sql/extension/maludb_core--0.85.0--0.86.0.sql \
              sql/extension/maludb_core--0.86.0--0.86.1.sql \
              sql/extension/maludb_core--0.86.1--0.87.0.sql \
              sql/extension/maludb_core--0.87.0--0.88.0.sql \
              sql/extension/maludb_core--0.88.0--0.89.0.sql \
              sql/extension/maludb_core--0.89.0--0.90.0.sql \
              sql/extension/maludb_core--0.90.0--0.91.0.sql \
              sql/extension/maludb_core--0.91.0--0.92.0.sql \
              sql/extension/maludb_core--0.92.0--0.93.0.sql \
              ...
              sql/extension/maludb_core--0.97.0--0.98.0.sql \
              sql/extension/maludb_core--0.98.0--0.99.0.sql \
              sql/extension/maludb_core--0.99.0--0.100.0.sql \
              sql/extension/maludb_core--0.74.0.sql \
              sql/extension/maludb_core--0.75.0.sql \
              sql/extension/maludb_core--0.76.0.sql \
              sql/extension/maludb_core--0.76.1.sql \
              sql/extension/maludb_core--0.77.0.sql \
              sql/extension/maludb_core--0.78.0.sql \
              sql/extension/maludb_core--0.79.0.sql \
              sql/extension/maludb_core--0.80.0.sql \
              ...
              sql/extension/maludb_core--0.83.0.sql \
              sql/extension/maludb_core--0.84.0.sql \
              sql/extension/maludb_core--0.85.0.sql \
              sql/extension/maludb_core--0.86.0.sql \
              sql/extension/maludb_core--0.86.1.sql \
              sql/extension/maludb_core--0.87.0.sql \
              sql/extension/maludb_core--0.88.0.sql \
              sql/extension/maludb_core--0.89.0.sql \
              sql/extension/maludb_core--0.90.0.sql \
              sql/extension/maludb_core--0.91.0.sql \
              sql/extension/maludb_core--0.92.0.sql \
              ...
              sql/extension/maludb_core--0.98.0.sql \
              sql/extension/maludb_core--0.99.0.sql \
              sql/extension/maludb_core--0.100.0.sql
