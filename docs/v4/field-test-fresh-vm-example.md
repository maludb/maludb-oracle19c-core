# MaluDB V4 Field-Test Report — Fresh VM `unbuntu24-02>` — `<2026-05-15>`
...
V4 is FIELD-TEST GREEN on a freshly-provisioned
Ubuntu 24.04 ubuntu24-02 at HEAD `<sha>` over the
`v4.0.0-rc.1` baseline. All 11 V4 acceptance criteria are
PASS.

**GA approved …>.** If approved, the GA tag
